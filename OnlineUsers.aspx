<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AdminMaster.Master" CodeBehind="OnlineUsers.aspx.vb" Inherits="UdupiElectricityBoard.OnlineUsers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="form1" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:UEB1ConnectionString2 %>" SelectCommand="SELECT [Name], [Address], [Email], [Mobile_No], [Aadhar_No], [RR_No], [Customer_No], [Sub_Division], [Location_Code], [Meter_Code], [Username] FROM [tblCustomer] WHERE [Username] IS NOT NULL AND [Deleted]='No'"></asp:SqlDataSource>
    </form>
</asp:Content>
