<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AdminMaster.Master" CodeBehind="AdminProfile.aspx.vb" Inherits="UdupiElectricityBoard.AdminProfile" %>
    ...
    <div class="form">
        <form runat="server" method="post">
            ...
            <div class="form-group">
                ...
                <%--<a runat="server" onclick="EditU()"><i runat="server" class="fa fa-pencil-square-o fa-lg"></i></a>--%>
            </div>
            <div class="form-group">
