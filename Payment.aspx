<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Payment.aspx.vb" Inherits="UdupiElectricityBoard.Payment" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
     <title>UEB-Payment</title>
    <!-- Meta-Tags -->
    ...
    <link rel="stylesheet" href="/assets/css/easy-responsive-tabs.css" type="text/css" media="all" />
...
<body>
    <a href="ViewBill.aspx"><i class="fa fa-arrow-left fa-lg" style="border:5px solid white !important; "></i></a>
        ...
        <div class="responsive_tabs w3ls_tab">
            <div id="horizontalTab">
                ...
                <div class="resp-tabs-container">
                    ...
                    <div class="tab1">
                        <div class="agile_pay">
                            <form action="#" method="post" class="creditly-card-form shopf-sear-headinfo_form" runat="server">
                                <section class="creditly-wrapper payf_wrapper">
                                    <div class="credit-card-wrapper">
                                        ...
                                        <button runat="server" class="submit" onserverclick="Bill" type="submit" >
                        ...
                        <div class="agile_pay">
                            <div class="vertical_post">
                                <form action="#" method="post">
                                    ...
                                    <input runat="server" onserverclick="Bill" type="submit" value="Pay now">
                                </form>
                            </div>
                        </div>
                    </div>
                                ...
                                <form action="#" method="post" class="creditly-card-form shopf-sear-headinfo_form">
                                    <section class="creditly-wrapper payf_wrapper">
                                        <div class="credit-card-wrapper">
                                            ...
                                            <input runat="server" onserverclick="Bill"  class="btn btn-primary submit" type="submit" value="Proceed Payment">
                                        </div>
                                    </section>
                                </form>
                            </div>
